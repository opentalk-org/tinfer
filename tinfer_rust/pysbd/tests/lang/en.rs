...
#[test]
fn en_matches_upstream() {
    assert_cases("en", false, None, CASES);
}
...
const CASES: &[(&str, &[&str])] = &[
    ...
    ("One further habit which was somewhat weakened . . . was that of combining words into self-interpreting compounds. . . . The practice was not abandoned. . . .", &["One further habit which was somewhat weakened . . . was that of combining words into self-interpreting compounds.", ". . . The practice was not abandoned. . . ."]),
];

#[test]
#[ignore = "upstream marks this fixture xfail"]
fn en_upstream_xfail_0() {
    assert_cases("en", false, None, &[("At 5 a.m. Mr. Smith went to the bank. He left the bank at 6 P.M. Mr. Smith then went to the store.", &["At 5 a.m. Mr. Smith went to the bank.", "He left the bank at 6 P.M.", "Mr. Smith then went to the store."])]);
}
