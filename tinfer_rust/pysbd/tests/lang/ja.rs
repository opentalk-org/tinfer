...
const GOLDEN_JA_RULES_TEST_CASES: &[Case] = &[
    Case {
        text: r#"これはペンです。それはマーカーです。"#,
        expected: &[r#"これはペンです。"#, r#"それはマーカーです。"#],
    },
    Case {
        text: r#"それは何ですか？ペンですか？"#,
        expected: &[r#"それは何ですか？"#, r#"ペンですか？"#],
    },
    Case {
        text: r#"良かったね！すごい！"#,
        expected: &[r#"良かったね！"#, r#"すごい！"#],
    },
    Case {
        ...
        expected: &[r#"自民党税制調査会の幹部は、「引き下げ幅は３．２９％以上を目指すことになる」と指摘していて、今後、公明党と合意したうえで、３０日に決定する与党税制改正大綱に盛り込むことにしています。"#, r#"２％台後半を目指すとする方向で最終調整に入りました。"#],
    },
];
...
const JA_TEST_CASES_CLEAN: &[Case] = &[
    Case {
        text: r#"これは父の
家です。"#,
        expected: &[r#"これは父の家です。"#],
