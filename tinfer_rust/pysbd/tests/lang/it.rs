...
const GOLDEN_IT_RULES_TEST_CASES: &[Case] = &[
    Case { text: r#"Salve Sig.ra Mengoni! Come sta oggi?"#, expected: &[r#"Salve Sig.ra Mengoni!"#, r#"Come sta oggi?"#] },
    Case {
    ...
    Case { text: r#"La casa costa 170.500.000,00€!"#, expected: &[r#"La casa costa 170.500.000,00€!"#] },
];
...
const IT_MORE_TEST_CASES: &[Case] = &[
    ...
    Case { text: r#"Chiamate il V.Cte. delle F.P., adesso!"#, expected: &[r#"Chiamate il V.Cte. delle F.P., adesso!"#] },
    Case { text: r#"Giancarlo ha sostenuto l'esame di econ. az.."#, expected: &[r#"Giancarlo ha sostenuto l'esame di econ. az.."#] },
    Case {
    ...
    Case { text: r#"Stava mangiando e/o dormendo."#, expected: &[r#"Stava mangiando e/o dormendo."#] },
    Case {
    ...
    Case { text: r#"La parola 'casa' è sinonimo di abitazione."#, expected: &[r#"La parola 'casa' è sinonimo di abitazione."#] },
    Case {
    ...
    Case {
        ...
        expected: &[
            r#""Ei fu. Siccome immobile / dato il mortal sospiro / stette la spoglia immemore / orba di tanto spiro / [...]" (Manzoni)."#,
        ],
    },
    Case {
    ...
    Case { text: r#"Ai bambini è stato chiesto di fare "4:2*2""#, expected: &[r#"Ai bambini è stato chiesto di fare "4:2*2""#] },
    Case {
        text: r#"La maestra esclamò: "Bambini, quanto fa '2/3 + 4/3?'"."#,
        expected: &[r#"La maestra esclamò: "Bambini, quanto fa '2/3 + 4/3?'"."#],
    },
    Case { text: r#"Il motore misurava 120°C."#, expected: &[r#"Il motore misurava 120°C."#] },
    Case { text: r#"Il volume era di 3m³."#, expected: &[r#"Il volume era di 3m³."#] },
    Case { text: r#"La stanza misurava 20m²."#, expected: &[r#"La stanza misurava 20m²."#] },
    Case { text: r#"1°C corrisponde a 33.8°F."#, expected: &[r#"1°C corrisponde a 33.8°F."#] },
    Case { text: r#"Oggi è il 27-10-14."#, expected: &[r#"Oggi è il 27-10-14."#] },
    Case { text: r#"La casa costa 170.500.000,00€!"#, expected: &[r#"La casa costa 170.500.000,00€!"#] },
    Case { text: r#"Il corridore 103 è arrivato 4°."#, expected: &[r#"Il corridore 103 è arrivato 4°."#] },
    Case { text: r#"Oggi è il 27/10/2014."#, expected: &[r#"Oggi è il 27/10/2014."#] },
    Case { text: r#"Ecco l'elenco: 1.gelato, 2.carne, 3.riso."#, expected: &[r#"Ecco l'elenco: 1.gelato, 2.carne, 3.riso."#] },
    Case { text: r#"Devi comprare : 1)pesce 2)sale."#, expected: &[r#"Devi comprare : 1)pesce 2)sale."#] },
    Case { text: r#"La macchina viaggiava a 100 km/h."#, expected: &[r#"La macchina viaggiava a 100 km/h."#] },
];
