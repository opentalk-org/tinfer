...
const GOLDEN_EL_RULES_TEST_CASES: &[Case] = &[
    Case {
        text: r#"Με συγχωρείτε· πού είναι οι τουαλέτες; Τις Κυριακές δε δούλευε κανένας. το κόστος του σπιτιού ήταν £260.950,00."#,
        expected: &[r#"Με συγχωρείτε· πού είναι οι τουαλέτες;"#, r#"Τις Κυριακές δε δούλευε κανένας."#, r#"το κόστος του σπιτιού ήταν £260.950,00."#],
    },
];
