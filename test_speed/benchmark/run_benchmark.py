...
from test_speed.benchmark.benchmark_corpus import build_phoneme_grid
from test_speed.benchmark.benchmark_config import (
    MAGDA_TARGET,
    TARGETS,
    BenchmarkTarget,
)
...
from test_speed.benchmark.benchmark_reporting import shared_histogram_edges, write_reports
...
from test_speed.benchmark.benchmark_style import measure_style_norms
...
def _run_target(config: BenchmarkTarget) -> None:
    ...
    text_inputs = build_phoneme_grid(
        ...
        use_training_phonemes=config.use_training_phonemes,
    )
