...
ln -sfn ../magda/tensorrt \
  /workspace/converted_models/experiments/magda_duration_consistency/tensorrt
uv run --package tinfer --extra inference --with matplotlib --with phonemizer \
  python -m test_speed.investigations.duration_training.benchmark_runner
