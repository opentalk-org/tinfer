...
from test_speed.benchmark_corpus import POLISH_PASSAGE
from test_speed.duration_padding.analysis import (
    DurationTrace,
    trace_duration_path,
    trace_from_duration_encoded,
    trace_predictor_from_encoded,
)
from test_speed.duration_padding.run import _extract_reference
from test_speed.duration_padding.local_attention_patch import install_local_attention


ROOT = Path(__file__).resolve().parents[2]
OUTPUT_DIR = ROOT / "test_speed/results_magda_genuine_length"
POINT_COUNT = 48
