...
from test_speed.duration_padding.analysis import trace_duration_path
from test_speed.duration_padding.report import write_report


ROOT = Path(__file__).resolve().parents[2]
MODEL_PATH = Path("/workspace/converted_models/magda/model.pth")
ARCHIVE_PATH = ROOT / "test_speed/archive.zip"
OUTPUT_DIR = ROOT / "test_speed/results_magda_duration_padding"
TEXT = (
